...
async function BookServicePage({ params }: { params: { serviceId: string } }) {
    ...
    // ✅ FIX: The Service type has 'providerId', not 'userId'.
                ...
                <div className="lg:col-span-2 space-y-6">
                    <Card className="shadow-lg">
                        <CardHeader>
                            ...
                            {/* ✅ FIX: 'totalReviews' is not a prop. Display it in a separate span. */}
                        ...
                        <CardContent>
                            ...
                            {service.images.length > 1 && (
                                <div className="mt-6">
                                    <h3 className="font-headline text-lg font-semibold mb-2">More Images</h3>
                                    <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                                        {/* ✅ FIX: Add explicit types for 'img' and 'idx' parameters. */}
